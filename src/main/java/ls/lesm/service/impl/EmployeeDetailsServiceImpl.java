	...
	public void fakerInsetEmpDetails( Principal principal) {
	 ...
	 Date fakerDate = faker.date().birthday();
	  ...
	  getMasterEmployeeDetails.setLastName(lastName);
	    ...
	    getMasterEmployeeDetails.setDepartments(this.departmentsRepository.findById(1).get());
	    getMasterEmployeeDetails.setDesignations(this.designationsRepository.findById(6).get());
	    ...
	    getMasterEmployeeDetails.setStatus(EmployeeStatus.BENCH);
	    getMasterEmployeeDetails.setSubDepartments(this.subDepartmentsRepositorye.findById(2).get());
	    getMasterEmployeeDetails.setSupervisor(this.masterEmployeeDetailsRepository.findById(4).get());
	    
	    MasterEmployeeDetails emp = this.masterEmployeeDetailsRepository.save(getMasterEmployeeDetails);
	    
	    getAddress.setAdressType(this.addressTypeRepository.findById(2).get());
	    ...
	    Integer salInInt = faker.number().numberBetween(25000, 200000);
